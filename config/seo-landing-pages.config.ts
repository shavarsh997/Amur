        ...
        faqs: [
          {
            ...
            answer:
              "Արժեքը կախված է մակերեսից, բնակարանի վիճակից, ապամոնտաժումից, ինժեներական աշխատանքներից, նյութերից և հարդարման բարդությունից։ Հաշվիչը տալիս է նախնական կողմնորոշիչ, իսկ ճշգրիտ նախահաշիվը կազմվում է զննումից հետո։",
          },
          {
          ...
          },
          {
            ...
            answer:
              "Այո։ Հաշվիչով ստացեք նախնական կողմնորոշիչ, ապա պատվիրեք զննում՝ ճշգրիտ նախահաշիվ ստանալու համար։",
          },
          {
      ...
      hy: {
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              "Ուղարկեք մակերեսը, հատակագիծը և խնդրի կարճ նկարագրությունը կամ պատվիրեք զննում։ Հաշվիչը տալիս է նախնական կողմնորոշիչ, իսկ ճշգրիտ նախահաշիվը պատրաստում ենք օբյեկտը ուսումնասիրելուց հետո։",
            ],
          },
        ],
        faqs: [
    ...
    translations: {
      ...
      hy: {
        ...
        sections: [
          ...
          {
            title: "Ինչու է քմ-ի գինը միայն կողմնորոշիչ",
            paragraphs: [
