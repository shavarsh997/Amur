        ...
        faqs: [
          {
            ...
            answer:
              "Այո։ Քննարկում ենք նախագիծը, տեղանքի պայմաններն ու անհրաժեշտ աշխատանքների կազմը, ապա առաջարկում ենք աշխատանքի հետագա համապատասխան քայլերը։",
          },
          {
      ...
      hy: content({
        ...
        faqs: [
          ...
          },
          {
            ...
            answer:
              "Քննարկում ենք խնդրի ծավալը և առաջարկում ենք աշխատանքի համապատասխան տարբերակը։",
          },
        ],
        ...hyLabels,
      }),
