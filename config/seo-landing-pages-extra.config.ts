...
export const extraSeoLandingPages = [
  {
    ...
    translations: {
      hy: content({
        ...
        planningText:
          "Սկզբում ճշտում ենք նախագիծը, տարածքի պայմանները, ցանկալի նյութերն ու փուլերը։ Դրանից հետո համաձայնեցնում ենք գործերի հերթականությունն ու նախնական նախահաշիվը։",
  ...
  },
  {
    ...
    translations: {
      hy: content({
        ...
        introduction: [
          "Առևտրային տարածքի վերանորոգումը պետք է աշխատի բիզնեսի նպատակին՝ այցելուի հարմարավետություն, գործառնական գոտիներ, տեսանելիություն և անվտանգություն։",
      ...
      hy: content({
        ...
        faqs: [
          ...
          },
          {
            ...
            answer:
              "Այո, նախնական կողմնորոշիչը կարելի է քննարկել, իսկ ճշգրիտ նախահաշիվը՝ զննումից հետո։",
          },
        ],
        ...hyLabels,
      }),
        ...
        faqs: [
          {
            ...
            answer:
              "Կարող ենք տալ նախնական կողմնորոշիչ, սակայն ճշգրիտ նախահաշիվը պահանջում է օբյեկտի տվյալներ և զննում։",
          },
          {
  ...
  },
  {
    ...
    translations: {
      hy: content({
        ...
        description:
          "Ինչու վերանորոգման մեկ քմ-ի գինը Երևանում կողմնորոշիչ է, և որ գործոններն են որոշում ձեր օբյեկտի իրական արժեքը։",
