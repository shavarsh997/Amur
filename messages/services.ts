    ...
    hy: serviceContent({
      ...
      workflow: [
        ...
        },
        {
          ...
          description:
            "Փակում ենք շենքի արտաքին եզրագիծը՝ հաջորդ փուլերի համար։",
        },
        {
  ...
  interiorDesign: {
    ...
    hy: serviceContent({
      ...
      suitableFor: [
        ...
        "Առևտրային տարածքների համար, որոնց անհրաժեշտ է գործառնական ինտերիեր",
      ],
      workTypes: [
      ...
      estimateRequirements: [
        ...
        "Հատակի պլան կամ առկա չափագրումներ",
  ...
  renovation: {
    ...
    hy: serviceContent({
      ...
      workflow: [
        ...
        {
          title: "Պլանավորում և նախնական նախահաշիվ",
          description:
