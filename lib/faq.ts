  ...
  hy: [
    {
      ...
      answer:
        "Նախնական կողմնորոշիչը կարող եք ստանալ առցանց, իսկ ճշգրիտ նախահաշիվը կազմվում է խնդիրը քննարկելուց և օբյեկտը զննելուց հետո։",
    },
    {
      question: "Պե՞տք է օբյեկտի զննում",
      answer:
        "Զննումը օգնում է գնահատել օբյեկտի սկզբնական վիճակը, ճշտել աշխատանքների ծավալը և պատրաստել իրատեսական հաշվարկ։",
    },
    {
      question: "Կարելի՞ է աշխատանքի ծավալը համաձայնեցնել մեկնարկից առաջ",
      answer:
        "Այո՛։ Մինչ աշխատանքը սկսելը քննարկում ենք խնդիրները, աշխատանքների ծավալն ու փուլերի հերթականությունը՝ նախագծի հարմար ձևաչափը համաձայնեցնելու համար։",
    },
    {
